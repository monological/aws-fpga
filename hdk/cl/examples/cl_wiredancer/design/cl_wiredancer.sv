...
assign cl_sh_pcim_arsize   = 3'b110;
assign cl_sh_pcim_arburst  = 2'b01;
assign cl_sh_pcim_arcache  = 4'b0011;
assign cl_sh_pcim_arlock   = 1'b0;
assign cl_sh_pcim_arprot   = 3'b000;
assign cl_sh_pcim_arqos    = 4'b0000;
